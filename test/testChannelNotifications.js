...
const {
  notifyChannelAboutNewParticipant,
} = require("../src/channelNotifications");
...
const EXPECTED_POST_DATA = {
  ...
  payload: JSON.stringify({
    text:
      ":heavy_plus_sign: `max.mustermann` hat sich zum nächsten Training angemeldet!",
  }),
};
describe("channelNotifications component", function () {
  ...
  it("should post about new participant with tuesday channel URL", function () {
    ...
    let result = notifyChannelAboutNewParticipant(
      "C012C7UEX9C",
      "max.mustermann"
    );
