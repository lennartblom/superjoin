...
describe('Training day via channel', function () {
    describe('post method', function () {
        it('should return Tuesday when being in #training-dienstag channel', function () {
            ...
            let expectedOutputThisWeek = "Du bist beim Training am Dienstag " + getDateInGermanFormat(thisWeeksTuesday) + " dabei :confetti_ball:";
            let expectedOutputNextWeek = "Du bist beim Training am Dienstag " + getDateInGermanFormat(nextWeeksTuesday) + " dabei :confetti_ball:";
        ...
        it('should return Thursday when being in #training-donnerstag channel', function () {
            ...
            let expectedOutputThisWeek = "Du bist beim Training am Donnerstag " + getDateInGermanFormat(thisWeeksThursday) + " dabei :confetti_ball:";
            let expectedOutputNextWeek = "Du bist beim Training am Donnerstag " + getDateInGermanFormat(nextWeeksThursday) + " dabei :confetti_ball:";
...
function getThisWeeksDay(plusOneWeek, dayConstant) {
    ...
    if (plusOneWeek) {
        ...
        newDate = new Date(nextWeeksTraining.setDate(nextWeeksTraining.getDate() + 7))
    }
